...
from transformer_completion.models.matcher import HungarianMatcher
from transformer_completion.utils.misc import (get_world_size, is_dist_avail_and_initialized,
...
class MaskLoss(nn.Module):
    ...
    def __init__(self, cfg, data_cfg):
        ...
        # self.matcher = HungarianMatcher(cfg.WEIGHTS, cfg.NUM_POINTS)
